...
\begin{center}
    ...
    \mbox{}\\[2.0cm]
    \textsc{\Huge MEEC/MIEEC}\\[2cm]
    \textsc{\LARGE Electronics for Micro-Systems}\\[2.0cm]
    \HRule\\[0.4cm]
    {\large \bf {Project \linebreak Voice Activity Detector}}\\[0.2cm] % [\texttt{EN}]
    \HRule\\[1.5cm]
\end{center}
...
\subfile{Sections/AnalogFrontEnd.tex}
\subfile{Sections/PMU.tex}
\subfile{Sections/DigitalInterface.tex}
\subfile{Sections/ImplementationAndTest.tex}
\subfile{Sections/UserInteraction.tex}
\subfile{Sections/ImplementationAndTest.tex}
